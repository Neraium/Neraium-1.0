...
from app.services.upload_pipeline import _run_temporal_math
...
def test_upload_pipeline_runs_temporal_math_for_sufficient_history() -> None:
...
def test_upload_pipeline_preserves_limited_temporal_result() -> None:
