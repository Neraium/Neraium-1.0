...
export const UPLOAD_STAGE_LABELS = Object.freeze({
  ...
  accepted: "Checking dataset...",
  queued: "Waiting to analyze...",
  claimed: "Worker claimed the job...",
  waiting: "Waiting for status...",
  stalled: "Worker heartbeat is stale...",
  validating_schema: "Checking dataset...",
  parsing: "Reading telemetry...",
  baseline_modeling: "Learning system relationships...",
  ...
  saving_results: "Saving Analysis",
  save_complete: "Behavior Baseline Established",
  navigation_pending: "Opening Analysis",
...
export function normalizeUploadStatus(status) {
  ...
  const map = {
    ...
    claimed: UPLOAD_STATUSES.CLAIMED,
    waiting: UPLOAD_STATUSES.WAITING,
    stalled: UPLOAD_STATUSES.STALLED,
