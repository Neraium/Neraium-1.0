...
export const UPLOAD_STAGE_LABELS = Object.freeze({
  ...
  accepted: "Validating telemetry evidence...",
  queued: "Preparing telemetry evidence...",
  validating_schema: "Validating telemetry evidence...",
  parsing: "Normalizing telemetry evidence...",
  baseline_modeling: "Discovering operational relationships...",
  processing: "Normalizing telemetry evidence...",
  structural_scoring: "Organizing system behavior...",
  building_fingerprint: "Establishing behavioral baseline...",
  writing_state: "Preparing operator findings...",
  cognition_ready: "Behavioral baseline ready...",
  saving_result: "Persisting behavioral baseline...",
  saving_results: "Persisting Behavioral Baseline",
  save_complete: "Behavioral Baseline Established",
  navigation_pending: "Opening Results",
  complete: "Behavior baseline established.",
