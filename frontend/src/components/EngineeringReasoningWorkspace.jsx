...
function WorkspaceStateNotice({ state, onPrimary }) {
  ...
  return (
    <section className={"operational-empty operational-empty--" + state.key} data-testid={"workspace-state-" + state.key}>
      <span className="operational-label">Status</span>
      <strong className="operational-status">{state.status}</strong>
