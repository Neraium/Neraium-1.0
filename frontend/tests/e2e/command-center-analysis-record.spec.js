...
function oversizedPayload() {
  ...
  const result = governedComparisonResult({ job_id: "large-run", facility_name: "Central Plant", sii_completed: true, sii_reliable_enough_to_show: true, data_quality: { coverage_percent: 100 }, analysis_result: analysis, analysis_explanation: analysis, baseline_analysis: { status: "available", relationship_drift: analysis.relationships } });
