...
LEGACY_STAGE_DEFAULTS: dict[str, tuple[int, str]] = {
    ...
    "parsing_telemetry": (20, "Profiling historical data..."),
    "detecting_schema_signals": (35, "Validating CSV..."),
    "cleaning_imputing_data": (45, "Building trusted canonical dataset..."),
    "profiling_data_quality": (55, "Profiling signal quality..."),
    ...
    "saving_result": (95, "Saving result..."),
    "building_relationship_baselines": (65, "Building baseline..."),
    "baseline_validating": (42, "Validating and normalizing telemetry..."),
    "baseline_quality_assessment": (55, "Assessing telemetry quality..."),
    "baseline_mode_identification": (66, "Identifying operating modes..."),
    "baseline_relationship_learning": (78, "Learning expected relationships..."),
    "baseline_model_fitting": (88, "Validating expected behavior..."),
    "baseline_candidate_persistence": (96, "Saving behavioral model candidate..."),
...
CANONICAL_STAGE_BY_LEGACY_STAGE = {
    ...
    "baseline_validating": "parsing",
    "baseline_quality_assessment": "processing",
    "baseline_mode_identification": "baseline_modeling",
    "baseline_relationship_learning": "baseline_modeling",
    "baseline_model_fitting": "building_fingerprint",
    "baseline_candidate_persistence": "saving_result",
...
CANONICAL_STAGE_LABELS = {
    ...
    "parsing": "Profiling historical data...",
    "baseline_modeling": "Identifying systems...",
    "processing": "Building trusted canonical dataset...",
