...
LEGACY_STAGE_DEFAULTS: dict[str, tuple[int, str]] = {
    ...
    "building_baseline": (65, "Building baseline..."),
    "scoring_drift_relationships": (75, "Scoring operating changes..."),
    "generating_findings_evidence": (85, "Preparing findings..."),
    "writing_result_replay": (95, "Writing result and replay..."),
