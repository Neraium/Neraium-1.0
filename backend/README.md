...
- Baseline progress uses `baseline_construction.v1` (`Import`, `Validate`, `Map`, `Learn`, `Review`, `Ready`) and returns a Baseline Suitability Report plus candidate Behavioral Digital Model. Monitoring uses the separate `sii_monitoring.v1` contract.
